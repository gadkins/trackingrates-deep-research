# TrackingRates Research Tool

A tool to help you research the web for information on shipping rates.
...
This tool is configured to use `gpt-4o` as the default LLM. However, with the [AI SDK](https://sdk.vercel.ai/docs), you can switch LLM providers to [OpenAI](https://openai.com), [Anthropic](https://anthropic.com), [Cohere](https://cohere.com/), and [many more](https://sdk.vercel.ai/providers/ai-sdk-providers) with just a few lines of code.
...
After deploying, you will need to get the environment variables [defined in `.env.example`](.env.example) to run Next.js AI Chatbot:
